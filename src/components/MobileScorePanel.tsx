...
import { ChevronUp, ChevronDown, Trophy, Zap } from "lucide-react";
...
export function MobileScorePanel({
  ...
  return (
    <div className="mobile-score-panel fixed top-4 right-4 z-40">
      {/* Botão de Toggle */}
      <motion.button
        whileTap={{ scale: 0.95 }}
          ...
          >
            ...
            <div className="flex gap-2">
              <motion.button
                ...
                className="flex-1 bg-gradient-to-r from-purple-600/80 to-purple-700/80 hover:from-purple-500/80 hover:to-purple-600/80 text-white font-bold py-2 px-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-1 text-sm"
              >
              ...
              <motion.button
                whileTap={{ scale: 0.95 }}
                onClick={onReset}
                className="flex-1 bg-gradient-to-r from-red-600/80 to-red-700/80 hover:from-red-500/80 hover:to-red-600/80 text-white font-bold py-2 px-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-1 text-sm"
              >
                <Trophy size={14} />
                Reset
              </motion.button>
